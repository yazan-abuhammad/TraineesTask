                                ...
                                <div class="form-body">
                                    <form action="{{route('store')}}" method="post" class="row g-3">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" class="form-control" id="inputusername" placeholder="Jhon" name="username">
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group" id="show_hide_password">
                                                <input type="password" class="form-control border-end-0" id="confirm password" value="12345678" placeholder="Enter Password" name="confirm_password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
